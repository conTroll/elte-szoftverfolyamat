...
<body class="ui page">
	...
	<div style="width: 50%; margin-left: 25%; margin-top: 5%;"
		...
		<div class="ui two column middle aligned relaxed grid basic segment">
			<div class="column">
				<form id="loginForm" class="ui form segment" action="<c:url value='j_spring_security_check' />" method="POST">
					...
					<div class="field">
						...
						<div class="ui left labeled icon input">
							<input name="username" type="text" placeholder="Username"> <i
								class="user icon"></i>
					...
					<div class="field">
						...
						<div class="ui left labeled icon input">
							<input name="password" type="password" placeholder="Password"> <i class="lock icon"></i>
							<div class="ui corner label">
								<i class="asterisk icon"></i>
							</div>
			...
			<div class="center aligned column">
				<div class="huge green ui labeled icon button" onclick="location.href='<c:url value="/registration"/>';">
